        ...
        switch(subj._c_type) {
            ...
            case _HIT_CIRCLE:
                if(this._rect.getX(RM_LEFT) <= subj._rect.getX(RM_CENTER) && subj._rect.getX(RM_CENTER) <= this._rect.getX(RM_RIGHT)) {
                    ...
                    var _temp;
                    _temp = dist(this._rect.getX(RM_TOPLEFT), this._rect.getY(RM_TOPLEFT), subj._rect.getX(RM_CENTER), subj._rect.getY(RM_CENTER));
                    if(dist(this._rect.getX(RM_TOPLEFT), this._rect.getY(RM_TOPLEFT), subj._rect.getX(RM_CENTER), subj._rect.getY(RM_CENTER)) <= subj._rect.width/2) {
                        return true;
                    }
                    _temp = dist(this._rect.getX(RM_TOPRIGHT), this._rect.getY(RM_TOPRIGHT), subj._rect.getX(RM_CENTER), subj._rect.getY(RM_CENTER));
                    if(dist(this._rect.getX(RM_TOPRIGHT), this._rect.getY(RM_TOPRIGHT), subj._rect.getX(RM_CENTER), subj._rect.getY(RM_CENTER)) <= subj._rect.width/2) {
                        return true;
                    }
                    _temp = dist(this._rect.getX(RM_BOTTOMLEFT), this._rect.getY(RM_BOTTOMLEFT), subj._rect.getX(RM_CENTER), subj._rect.getY(RM_CENTER));
                    if(dist(this._rect.getX(RM_BOTTOMLEFT), this._rect.getY(RM_BOTTOMLEFT), subj._rect.getX(RM_CENTER), subj._rect.getY(RM_CENTER)) <= subj._rect.width/2) {
                        return true;
                    }
                    _temp = dist(this._rect.getX(RM_BOTTOMRIGHT), this._rect.getY(RM_BOTTOMRIGHT), subj._rect.getX(RM_CENTER), subj._rect.getY(RM_CENTER));
                    if(dist(this._rect.getX(RM_BOTTOMRIGHT), this._rect.getY(RM_BOTTOMRIGHT), subj._rect.getX(RM_CENTER), subj._rect.getY(RM_CENTER)) <= subj._rect.width/2) {
                        return true;
                    }
                    return false;
                }
        ...
        switch(subj._c_type) {
            case _HIT_RECT:
                if(subj._rect.getX(RM_LEFT) <= this._rect.getX(RM_CENTER) && this._rect.getX(RM_CENTER) <= subj._rect.getX(RM_RIGHT)) {
                    ...
                    if(dist(subj._rect.getX(RM_TOPLEFT), subj._rect.getY(RM_TOPLEFT), this._rect.getX(RM_CENTER), this._rect.getY(RM_CENTER)) <= this._rect.width/2) {
                        return true;
                    }
                    if(dist(subj._rect.getX(RM_TOPRIGHT), subj._rect.getY(RM_TOPRIGHT), this._rect.getX(RM_CENTER), this._rect.getY(RM_CENTER)) <= this._rect.width/2) {
                        return true;
                    }
                    if(dist(subj._rect.getX(RM_BOTTOMLEFT), subj._rect.getY(RM_BOTTOMLEFT), this._rect.getX(RM_CENTER), this._rect.getY(RM_CENTER)) <= this._rect.width/2) {
                        return true;
                    }
                    if(dist(subj._rect.getX(RM_BOTTOMRIGHT), subj._rect.getY(RM_BOTTOMRIGHT), this._rect.getX(RM_CENTER), this._rect.getY(RM_CENTER)) <= this._rect.width/2) {
                        return true;
                    }
                    return false;
                }
